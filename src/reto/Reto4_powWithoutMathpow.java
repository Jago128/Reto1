...
public class Reto4_powWithoutMathpow {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (!exit.equals("NO")) {
				...
				} while (!opcion.equalsIgnoreCase("a")&&!opcion.equalsIgnoreCase("b")&&!opcion.equalsIgnoreCase("c")&&!opcion.equalsIgnoreCase("d")&&!opcion.equalsIgnoreCase("e")&&!opcion.equalsIgnoreCase("f"));
